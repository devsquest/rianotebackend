<template>
  <div class="vue-section-part" style="margin-top: -1em">
    <div class="questionnaire" v-if="section_type == 'questionnaire'">
      <div class="row" v-if="currentSubSectionList != null && currentSubSectionList.length > 0">
        <div class="col-lg-4 col-md-4">
          <br />
          <div class="row">
            <div class="col-lg-12">
              <div class="note-section-left">
                <div v-for="x in currentSubSectionList" :key="x.id" :class="[
                  'note-section-left-li',
                  { 'note-section-left-li-selected': x.showStatus },
                ]">
                  <span class="note-section-left-text" v-on:click="loadSubSection(x.id, x.type, x.name)">{{ x.name
                  }}</span>
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-8 col-md-8">
          ...
          <div class="row" v-if="showByDefault">
            <div class="col-lg-12" v-if="current_sub_section == 'questionnaire'">
              <div class="tools-area">
                ...
                <div class="questions">
                  <div class="single-tools-area" v-for="x in currentSectionQuestions" :key="x.id">
                    <div class="tools-heading mt-2">
                      <h6 class="bold-heading" v-if="x.only_show_options == false">
                        {{ x.question_text }}:
                      </h6>
                    </div>
                      ...
                      <div class="row">
                        <div v-for="option in x.options" :key="option.id"
                          ...
                          <div v-if="option.editAble">
                            <button class="note-btn-hover-edit-danger" v-on:click="hideOption(x, option)">
                              <span><i class="fa-solid fa-xmark"></i></span>
                            </button>
                            <button class="note-btn-hover-edit-success" v-on:click="saveOption(x, option)">
                              <span><i class="fa-solid fa-floppy-disk"></i></span>
                            </button>
                          </div>
                          <div v-else>
                            <button class="note-btn-hover-edit" v-on:click="editOption(x, option)">
                              <span><i class="
                    ...
                    <div class="tools-option-add-new">
                      ...
                      <button v-on:click="addOwnCustomPhrase()" class="btn btn-new-phrase">
                        <i class="fa-solid fa-plus"></i> Add your own custom
                        phrase
                      </button>
                    </div>
                    <div class="tools-option-input-box" v-if="new_phrase.isDisplay">
                      <input type="text" v-model="new_phrase.option_text" class="form-control mt-3"
                        placeholder="Option Phrase" />
                    </div>
                    <div class="tools-option-input-box-btn mt-2" v-if="new_phrase.isDisplay">
                      <button class="btn btn-primary btn-14px" v-on:click="saveNewPhrase(x)">
                        <i class="fa fa-save"></i>
                      </button>
                      <button class="btn btn-danger btn-14px" v-on:click="closeNewPhraseInput">
            ...
            <!--col-->
            <div class="col-lg-12" v-else-if="current_sub_section == 'statements'">
              <div class="tools-area">
                <div class="search-box">
                  <input type="text" placeholder="Enter Search Here" class="tool-input" />
                  <i class="fa-solid fa-magnifying-glass tool-input-icon"></i>
                ...
                <div class="questions">
                  <div class="single-tools-area" v-for="x in currentSectionQuestions" :key="x.id">
                    ...
                    <div class="tools-statement-lines">
                      <h6 class="bold-heading" v-for="sm in x.statement_master" :key="sm.id">
                        {{ sm.short_text }} = {{ sm.statement_text }}:
                      </h6>
                    </div>
                    <div class="tools-options">
                      <div v-for="sd in x.statement_detail" :key="sd.id" class="single-tools-option">
                        <h6 class="bold-heading">{{ sd.title }}:</h6>
                        <div class="statement-lists">
                          <div class="row" v-for="option in sd.options" :key="option.id">
                            <div class="col-3">
                              <button v-for="sm in x.statement_master" :key="sm.id" :class="[
                                'btn',
    ...
    <div class="form-inline" v-else-if="section_type == 'form-inline'">
      <div class="row" v-if="currentFormQuestions != null && currentFormQuestions.length > 0">
        <div class="col-lg-12 col-md-12">
          ...
          <div class="row">
            ...
            <div class="col-lg-12 col-md-12" v-for="x in currentFormQuestions" :key="x.id">
              <div class="note-input-group">
                <div class="note-input-group-head">
                  <h6 class="bold-heading">{{ x.question_text }}:</h6>
                </div>
                <div class="note-input-group-field">
                  <input type="text" class="form-control" style="width: 95%" v-model="x.textInput" />
                </div>
              </div>
            </div>
          </div>
