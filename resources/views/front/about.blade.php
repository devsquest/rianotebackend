...
<div class="container-fluid ">
    ...
    <div class="row scnd-pg">
        <div class="col-md-12">
            <h3 class="scnd-pg-h">NOTE DESIGNER WAS <br>
            ...
            <p class="scnd-pg-p">As a clinical psychologist in practice for over 20 years, I (Patricia) was well
        ...
        <div class="section">
            <div class="container">
                ...
                <div class="row pic">
                    ...
                    <div class="col-md-2 hide"><img src="Home_32.png" class="img-fulid" alt="boy pic"></div>
                    <div class="col-md-2  hide pic-down"><img src="Home_38.png" class="img-fulid" alt="boy pic">
                    </div>
                    <div class="col-md-2 hide "><img src="Home_34.png" class="img-fulid" alt="boy pic"></div>
