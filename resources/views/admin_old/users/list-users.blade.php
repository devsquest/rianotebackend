                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row m-b-20">
                            <div class="col-sm-12">
                                <a class="btn btn-success btn-sm" href="{{ url('admin/register') }}">Create A User</a>
                            </div>
                                ...
                                <table class="tablesaw table-bordered table-hover table" data-tablesaw-sortable>
                                    ...
                                    @foreach( $users as $key => $user)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-info btn-sm" href="{{url('admin/edit-user', ['id'=>$user->id])}}"> Edit </a>
                                                <a class="btn btn-danger btn-sm" href="{{url('admin/switch-user', ['id'=>$user->id])}}"> In-Active </a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 m-t-20">
                                        <div class="dataTables_info" id="editable-datatable_info" role="status" aria-live="polite">Showing
                                           {{ count($users) }} of {{ $users->total() }} entries</div>
                                    </div>
                                </div>
                            </div>
                        </div>
