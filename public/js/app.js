...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _parts_HeadingPart_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./parts/HeadingPart.vue */ "./resources/js/components/note/parts/HeadingPart.vue");
/* harmony import */ var _parts_SectionPart_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./parts/SectionPart.vue */ "./resources/js/components/note/parts/SectionPart.vue");


/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "MasterLayout",
  components: {
    HeadingPart: _parts_HeadingPart_vue__WEBPACK_IMPORTED_MODULE_0__["default"],
    SectionPart: _parts_SectionPart_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  data: function data() {
    return {
      section_type: null,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return _this.axios.get("http://127.0.0.1:8000" + "/api/sections/" + _this.note_id + "/" + _this.section_type + "/" + _this.slug, {
                  headers: headers
                }).then(function (response) {
                  if (response.data.data.sections.length > 0) {
                    _this.sub_sections_list = response.data.data.sections;
                  } else {
                    _this.sub_sections_list = null;
                  }
                })["catch"](function (error) {
                  console.log(error);
                });
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _this2.$store.dispatch("note/getQuestions", id).then(function () {
                  var store = _this2.$store.state.note.questions;

                  _this2.$store.commit("note/currentSelectedSection", store.get("s" + _this2.current_section_id));
                });
    ...
    addQuestionInResult: function addQuestionInResult(question_id, option_id) {
  ...
  computed: {
    currentSelectedSection: function currentSelectedSection() {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "note-heading-text-value"
  }, [_vm._v(_vm._s(_vm.note.fee))])]) : _vm._e(), _vm._v(" "), _c("div", {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "splash-btn",
    on: {
      click: _vm.newNoteBtn
    }
  }, [_vm._v("Start a new Note")]), _vm._v(" "), _c("button", {
    staticClass: "splash-btn"
  }, [_vm._v("Go to Dashboard")])])])])])])])])])]), _vm._v(" "), _c("div", {
    staticClass: "modal fade",
    attrs: {
      id: "newNoteModal",
      tabindex: "-1",
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, _vm._l(_vm.sub_sections_list, function (x) {
    return _c("div", {
      key: x.id,
  ...
  }, _vm._l(_vm.currentSelectedSection, function (x) {
    return _c("div", {
      key: x.id,
      ...
      return _c("div", {
        ...
        staticClass: "note-questions-single-option-box",
        on: {
          click: function click($event) {
  ...
  }), 0)])])]) : _vm._e()])])]) : _vm.section_type == "form-inline" ? _c("div", {
    ...
    staticClass: "row"
  }, [_vm._m(1), _vm._v(" "), _vm._l(_vm.sub_sections_list, function (x) {
    return _c("div", {
      key: x.id,
      staticClass: "col-lg-12 col-md-12"
    }, [_c("div", {
      ...
      staticClass: "bold-heading"
    }, [_vm._v(_vm._s(x.question_text) + ":")])]), _vm._v(" "), _vm._m(2, true)])]);
  })], 2)])])]) : _vm._e()]);
};
