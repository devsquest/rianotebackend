...
vue__WEBPACK_IMPORTED_MODULE_5__["default"].prototype.$appConfig = _configuration__WEBPACK_IMPORTED_MODULE_3__["default"];
...
/* harmony import */ var _modules_cart__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/cart */ "./resources/js/store/modules/cart.js");
...
var mutations = {
  addToCart: function addToCart(state, payload) {
    ...
    var indexOfObject = state.cart.findIndex(function (object) {
  ...
  removeCart: function removeCart(state, payload) {
    var indexOfObject = state.cart.findIndex(function (object) {
